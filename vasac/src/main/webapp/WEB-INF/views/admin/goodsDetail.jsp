...
<div class="wrapper">
  ...
  <div class="content-wrapper">
		...
		<h1 style="padding:20px 10px;">상품상세보기</h1>
   ...
   <table class="table table-striped table-bordered">	 
	...
	<tr>
		<th>내용</th>                                    
		<td>
		<pre style="margin:0px; padding:0px">${goods.gdsDes}</pre>
		</td>
	</tr>

	<tr>
		<th>상품이미지</th>                                    
		<td><img src="/resources/${goods.gdsImg}"></td>
	</tr>

	</table>
	
	<div class="button">
	<a class="btn btn-primary" href="goodsModifyForm?gdsNum=${goods.gdsNum}">상품수정</a>
	<a class="btn btn-primary" href="goodsDelete?gdsNum=${goods.gdsNum}">상품삭제</a>
	</div>
  </div>
  <!-- /.Main -->
